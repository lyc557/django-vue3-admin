	...
	setup() {
			...
			homeOne: [
				{
					...
					num2: '-12.32',
					num3: '会话统计信息',
					num4: 'fa fa-comments',  // 修改为对话图标，更符合会话统计
					color1: '#FF6462',
				...
				},
				{
					...
					num2: '+42.32',
					num3: '用户统计信息',
					num4: 'fa fa-users',  // 修改为用户图标，更符合用户统计
					color1: '#6690F9',
				...
				},
				{
					...
					num2: '+17.32',
					num3: '文档统计信息',
					num4: 'fa fa-file-text-o',  // 修改为文档图标，更符合文档统计
					color1: '#6690F9',
				...
				},
				{
					...
					num2: '-10.01',
					num3: '访问统计信息',
					num4: 'fa fa-eye',  // 修改为眼睛图标，更符合访问统计
					color1: '#FF6462',
		...
		const initLineChart = () => {
			...
			const option = {
				...
				legend: { data: ['文档上传量', '用户查询量'], right: 0 },
				xAxis: {
				...
				series: [
					{
						...
						symbol: 'circle',
						smooth: true,
						data: [42, 65, 78, 95, 120, 135, 142, 132, 125, 145, 162, 178],
					...
					},
					{
						...
						symbol: 'circle',
						smooth: true,
						data: [156, 230, 245, 310, 385, 420, 456, 482, 520, 575, 612, 678],
		...
		const initPieChart = () => {
			...
			var getname = ['技术文档', '产品手册', '研究报告', '会议记录', '培训资料'];
			var getvalue = [35.6, 25.8, 18.5, 12.2, 7.9];
			var data = [];
		...
		const initBarChart = () => {
			...
			const option = {
				...
				tooltip: { trigger: 'axis' },
				legend: { data: ['查询次数', '平均响应时间(ms)', '满意度(%)'], right: 0 },
				grid: { top: 70, right: 80, bottom: 30, left: 80 },
				xAxis: [
					{
						type: 'category',
						data: ['直接检索', '语义搜索', 'AI问答', '知识推荐', '文档全文'],
						axisLabel: {
							interval: 0,
							rotate: 30,
						},
